/**
 * @brief Yutani - The SiriusOS Window Compositor.
 *
...
#define _DEBUG_YUTANI_NG
#ifdef _DEBUG_YUTANI_NG
#include <sirius/trace.h>
#define TRACE_APP_NAME "yutani-ng"
#else
#define TRACE(msg,...)
#endif
...
static int usage(char * argv[]) {
	fprintf(stderr,
			...
			"\n"
			"  Yutani-NG is the standard system compositor.\n"
			"\n",
			argv[0]);
	return 1;
}
