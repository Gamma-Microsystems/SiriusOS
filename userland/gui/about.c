 ...
 *
 * By default, shows "About SiriusOS", suitable for use as an application
...
static void init_default(void) {
...

	{
		...
		sprintf(version_str, "SiriusOS %s", u.release);
	}

	copyright_str[0] = "© 2011-2024 K. Lange, et al.";
	copyright_str[1] = "© 2024 Gamma Microsystems.";
	copyright_str[2] = "-";
